...
public partial class DownloadFile : System.Web.UI.Page
{
    ...
    void DownloadAllPOs()
    {
        DataTable dtExport = (DataTable)Session["allPODgrid"];
        if (dtExport.Rows.Count > 0)
        {
            string attachment = "attachment; filename=" + Session["SOrgName"].ToString() + "_" + Session["CompCode"].ToString() + "_POs" + ".xls";
            ...
            Response.End();
            //Response.Clear();
            //Response.AddHeader("content-disposition", "attachment;filename= " + Session["SOrgName"].ToString() + "_" + Session["CompCode"].ToString() + "_POs" + ".xls");
            //Response.Charset = "";
