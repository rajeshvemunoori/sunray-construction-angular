...
public partial class MyAccount : System.Web.UI.Page
{
    ...
    private void LoadUserDetails()
    {
        ...
        // AIT-28: showing ManagerEmail from logged in user details.
        txtManager.Text = Session["ManagerEmail"].ToString(); //ds.Tables[0].Rows[0]["ManagerEmail"].ToString(); 
        ...
        // AIT-28: showing UserGroup from logged in user details.
        txtUserGrp.Text = Session["UserGroup"].ToString(); //ds.Tables[0].Rows[0]["userGroup"].ToString();
