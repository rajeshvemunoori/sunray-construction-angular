...
public partial class EditOrganization : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        if (dsorg.Tables[0].Rows.Count > 0)
        {
            ...
            txtAddr1.Value = dsorg.Tables[0].Rows[0]["Address1"].ToString();
            txtAddr2.Value = dsorg.Tables[0].Rows[0]["Address2"].ToString();
            ...
            if (dsorg.Tables[0].Rows[0]["LogoPath"].ToString() != string.Empty)
            {
                ...
                divLogoatt.InnerHtml = "<a class='badge badge-waring' href='../downloadFile.aspx?typ=5&aid=" + filepath + "&ext=" + fileName + "'>Current Logo</a>";
    ...
    private void UpdateOrgDetails()
    {
        ...
        if (txtUrl.Text != dsorg.Tables[0].Rows[0]["URL"].ToString())
            isUpdate = true;
        if (txtAddr1.Value != dsorg.Tables[0].Rows[0]["Address1"].ToString())
            isUpdate = true;
        if (txtAddr2.Value != dsorg.Tables[0].Rows[0]["Address2"].ToString())
            isUpdate = true;
        ...
        if (isUpdate)
        {
            ...
            orgDetails.address1 = txtAddr1.Value;
            orgDetails.address2 = txtAddr2.Value;
