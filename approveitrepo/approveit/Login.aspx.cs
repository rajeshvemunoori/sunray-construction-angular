    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                txtEmail.Focus();
                //Response.Write("<script>alert('" + xms.sendMail("vivek@xtramilesoft.com", "vivek@xtramilesoft.com", "Test Mail", "Test Body", 987, "", "ABC") + "')</script>"); 
            }
        }
        catch (Exception ex)
        {
        ...
        if (!string.IsNullOrEmpty(hdnQSEmail.Value))
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    dvError.InnerHtml = "Please Note:- This reqeust can only be approved by the same email to which it was sent for approval.";
                }
            }
        }
        else
