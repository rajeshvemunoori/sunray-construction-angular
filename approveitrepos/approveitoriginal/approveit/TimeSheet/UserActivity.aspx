...
<head runat="server">
    ...
    <link rel="stylesheet" href="../Content/themes/redmond/jquery-ui.css" type="text/css" />
    <link rel="stylesheet" href="../Styles/udf/ufd-base.css" type="text/css" />
    <link rel="stylesheet" href="../Styles/udf/plain/plain.css" type="text/css" />
                    ...
                    <section class="grid_7" style="padding-top: 0px">
                        ...
                        <asp:UpdatePanel ID="updNotes" runat="server" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                ...
                                <div class="main-content grid_4 alpha" style="width: 1150px; padding-top: 0px">
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="text-align: right">
                                                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="buttonnew-green" OnClick="SaveWeekTimeSheet" />
                                                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="buttonnew-blue" OnClick="SubmitTimeSheet" Visible="false"></asp:Button>
                                                        <asp:Button ID="btnGoToTimesheet" runat="server" Text="Go To Timesheet" CssClass="buttonnew-blue" OnClick="btnGoToTimesheet_Click" />
                                                        <asp:Button ID="btnShowAllTimesheet" runat="server" Text="Show All Timesheet" CssClass="buttonnew-blue" OnClick="btnShowAllTimesheet_Click" Visible="false" />
                                    ...
                                    <section>
                                        <div class="divfieldset">
                                            <div id="dvAllTS" runat="server">
                                                ...
                                                <br />
                                                <div id="dvDates" style="width: 40%">
                                                    <div class="main-content" style="width: 100%; min-height: 100px">
                                                        <header>
                                                            <h2 class="pophead">Select Start Date</h2>
                                                        </header>
                                                        <section>
                                                            <table class="tab">
                                                                <tr>
                                                                    ...
                                                                    <td><small>
                                                                        <label>To:</label></small><br />
                                                                        <asp:TextBox ID="txtToDate" runat="server" class="date"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnGo" runat="server" Text="Go" CssClass="buttonnew-blue" OnClick="btnGo_Click" /></td>
                                                                </tr>
                                                            </table>
                                                        </section>
                                                    </div>
                                            ...
                                            <div id="dvManageTS" runat="server" style="display: none">
                                                <div id="dvErr" runat="server" style="font-size: 1.5em; text-align: center"></div>
                                                        ...
                                                        <td width="55%" style="vertical-align: top">
                                                            <table width="100%">
                                                                <tr>
                                                                    <td class="tdfld">
                                                                        <small>
                                                                            <label>Tracking Type:</label></small><br />
                                                                        <asp:DropDownList ID="ddlTrackingType" runat="server" Width="135px" OnSelectedIndexChanged="ddlTrackingType_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                                    </td>
                                                                    ...
                                                                    <td class="tdfld">
                                                                        <div id="dvYear" runat="server">
                                                                            <small>
                                                                                <label>Year:</label></small><br />
                                                                            <asp:DropDownList ID="ddlYear" runat="server" Width="135px" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                                        </div>
                                                                    </td>
                                                                    <%} %>
                                                                    <td class="tdfld"><small>
                                                                        <label>Task Start Date:</label></small><br />
                                                                        <asp:TextBox ID="txtTaskDate" runat="server"></asp:TextBox>
                                                                        <asp:DropDownList ID="ddlStartDate" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlStartDate_SelectedIndexChanged"></asp:DropDownList>
                                                                ...
                                                                <tr>
                                                                    <td class="tdfld">
                                                                        <small>
                                                                            <label>Job Name:</label></small><br />
                                                                        <asp:DropDownList ID="ddlJobName" runat="server" Width="135px" AutoPostBack="true" OnSelectedIndexChanged="ddlJobName_SelectedIndexChanged"></asp:DropDownList>
                                                                    ...
                                                                    <%if (ddlTrackingType.SelectedValue.ToLower().Contains("auto"))
                                                                      { %>
                                                                    <td class="tdfld">
                                                                        <div id="dvTaskName" runat="server">
                                                                            <small>
                                                                                <label>Task Name:</label>
                                                                            </small>
                                                                            <br />
                                                                            <asp:DropDownList ID="ddlTaskName" runat="server" Width="135px" AutoPostBack="true" OnSelectedIndexChanged="ddlTaskName_SelectedIndexChanged"></asp:DropDownList>
                                                                        </div>
                                                                    </td>
                                                                    <%} %>
                                                                    <td class="tdfld">
                                                                        <small>
                                                                            <label>Job Description:</label></small><br />
                                                                        <asp:TextBox ID="txtJobDescr" runat="server" TextMode="MultiLine" ReadOnly="true"></asp:TextBox>
                                                                    </td>
                                                                    <td></td>
                                                                </tr>
                                                            </table>
                                                                            ...
                                                                            <table width="100%">
                                                                                <tr>
                                                                                    <td colspan="3" class="tdfld">
                                                                                        <asp:Button ID="btnStartTask" runat="server" Width="120px" Text="Start" CssClass="buttonnew-blue" OnClick="StartTask" />
                                                                                        <asp:Button ID="btnEndTask" runat="server" Width="120px" Text="End" CssClass="buttonnew-blue" OnClick="EndTask" Visible="false" />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <div id="dvAutoNotes" runat="server">
                                                                                            <small>
                                                                                                <label>Notes:</label></small><br />
                                                                                            <asp:TextBox ID="txtAutoTSNotes" runat="server" TextMode="MultiLine" placeholder="Enter notes (if any) before you end task." Width="250px" Height="80px"></asp:TextBox>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Panel ID="pnlMondayNotes" runat="server">
                                                                                <div class="main-content" style="margin: 0px 0px 0px 5px; background-color: White; padding: 0 0px 5px 0px; min-height: 80%; min-width: 230px; height: 150px;">
                                                                                    ...
                                                                                    <section>
                                                                                        <asp:TextBox ID="txtMondayNotes" runat="server" TextMode="MultiLine" Width="180px" Height="70px"></asp:TextBox>
                                                                                    </section>
                                                                                </div>
                                                                            </asp:Panel>
                                            ...
                                            <div id="dvTotalHrs" runat="server" style="display: none" class="message info">
                                                <table width="100%">
                                                    <tr>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td align="right" style="width: 34%">
                                                        <asp:Button ID="btnCommentsSave" runat="server" Text="Submit" CssClass="buttonnew-blue" OnClick="btnCommentsSave_Click"></asp:Button>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td align="right" style="width: 50%">
                                                        <asp:Button ID="btnYesMinTaskTimeVal" runat="server" OnClick="ConfirmEndTask" Text="Yes" CssClass="buttonnew-blue" />
                                                        <asp:Button ID="btnNoMinTaskTimeVal" runat="server" Text="No" CssClass="buttonnew-blue" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </header>
