                                            ...
                                            <tr>
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td class="mainlabel">
                                                                <a href="Codes/Compcodecreation.aspx" style="text-decoration: none; color: inherit">
                                                                    Company Codes</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="maintable">
                                                                <table width="100%">
                                                                    <tr>
                                                                        <td colspan="2" align="right">
                                                                            <asp:LinkButton ID="lnkExpRefresh" runat="server" OnClick="RefreshExpenses" Style="text-decoration: none;
                                                                                color: inherit;"> <span class="message symbol">&#x27F3;</span></asp:LinkButton>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
