...
public partial class Invoice : System.Web.UI.Page
{
    ...
    string accountCode, addedBy, amtPaid, cancelFlag, comments, compCode, description, detailsFlag, dueDate, expLineNo, invarray, invDate, invLineNo, invName, invNo, invoiceId,
    ...
    private void CloneDataRow(string cancelFlg)
    {
        ...
        dtInv.Rows[index]["detailsFlag"] = "Y";
    ...
    private void SaveInvDetails()
    {
        ...
        for (int i = 0; i < dtInv.Rows.Count; i++)
        {
            ...
            if (ut.NullSafeDouble(dtInv.Rows[i]["poInvAmount"]) > 0 && hdnCancelledRow.Value.ToLower() != "y")
            {
                ...
                totalInvAmt += hdnTotInvAmnt.Value + appString;
                type += "1" + appString;
