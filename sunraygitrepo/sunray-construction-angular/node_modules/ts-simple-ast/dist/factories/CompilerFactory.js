...
var CompilerFactory = /** @class */ (function () {
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _a = tslib_1.__values(this.getDirectoriesByDepth()), _b = _a.next();
                    _d.label = 1;
                case 1:
    ...
    CompilerFactory.prototype.getDiagnostic = function (diagnostic) {
        var _this = this;
        return this.diagnosticCache.getOrCreate(diagnostic, function () { return new compiler_1.Diagnostic(_this.global, diagnostic); });
    };
    /**
