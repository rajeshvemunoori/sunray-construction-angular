...
var Project = /** @class */ (function () {
    ...
    Project.prototype.addExistingSourceFiles = function (fileGlobs, options) {
        ...
        try {
            for (var _a = tslib_1.__values(this.global.fileSystemWrapper.glob(fileGlobs)), _b = _a.next(); !_b.done; _b = _a.next()) {
        ...
        try {
            ...
            try {
                if (globbedDirectories_1_1 && !globbedDirectories_1_1.done && (_d = globbedDirectories_1.return)) _d.call(globbedDirectories_1);
            }
    ...
    Project.prototype._addSourceFilesForTsConfigResolver = function (tsConfigResolver, compilerOptions, addOptions) {
        ...
        try {
            for (var _a = tslib_1.__values(paths.directoryPaths), _b = _a.next(); !_b.done; _b = _a.next()) {
                var dirPath = _b.value;
    ...
    Project.prototype.getSourceFiles = function (globPatterns) {
        ...
        function getFilteredSourceFiles() {
            function getSourceFilePaths() {
                var sourceFiles_1, sourceFiles_1_1, sourceFile, e_4_1, e_4, _a;
            ...
            var sourceFilePaths, matchedPaths, matchedPaths_1, matchedPaths_1_1, matchedPath, e_5_1, e_5, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    Project.prototype.saveSync = function () {
        ...
        try {
            ...
            for (var _a = tslib_1.__values(this.getUnsavedSourceFiles()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var file = _b.value;
                file.saveSync();
            }
        }
    ...
    Project.prototype.getUnsavedSourceFiles = function () {
        ...
        function getUnsavedIterator(sourceFiles) {
            var sourceFiles_2, sourceFiles_2_1, sourceFile, e_7_1, e_7, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, 6, 7]);
