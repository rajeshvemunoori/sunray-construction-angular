...
var LanguageService = /** @class */ (function () {
    ...
    LanguageService.prototype.renameLocations = function (renameLocations, newName) {
        ...
        try {
            for (var _b = tslib_1.__values(renameLocationsBySourceFile.getEntries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var _d = tslib_1.__read(_c.value, 2), sourceFile = _d[0], locations = _d[1];
     ...
     * @param node - Node.
     */
    LanguageService.prototype.getDefinitionReferencingNodes = function (node) {
        var references = this.findReferences(node);
        return utils_1.ArrayUtils.from(getReferencingNodes());
        function getReferencingNodes() {
            var references_1, references_1_1, referenceSymbol, isAlias, _a, _b, reference, e_3_1, e_4_1, e_4, _c, e_3, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        _a = tslib_1.__values(referenceSymbol.getReferences()), _b = _a.next();
                        _e.label = 3;
                    case 3:
    ...
    LanguageService.prototype.organizeImports = function (filePathOrSourceFile, settings) {
