...
var Identifier = /** @class */ (function (_super) {
    ...
    Identifier.prototype.getDefinitionNodes = function () {
        return this.getDefinitions().map(function (d) { return d.getNode(); }).filter(function (d) { return d != null; });
    };
    /**
    ...
    return Identifier;
}(base_1.ReferenceFindableNode(PrimaryExpression_1.PrimaryExpression)));
