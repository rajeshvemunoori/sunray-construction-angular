...
var Node = /** @class */ (function () {
    ...
    Node.prototype.forget = function () {
        if (this.wasForgotten())
            return;
        try {
            for (var _a = tslib_1.__values(this.getChildrenInCacheIterator()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var child = _b.value;
                child.forget();
            }
        }
    ...
    Node.prototype.isInStringAtPos = function (pos) {
        ...
        if (this._childStringRanges == null) {
            ...
            try {
                for (var _a = tslib_1.__values(this.getCompilerDescendantsIterator()), _b = _a.next(); !_b.done; _b = _a.next()) {
    ...
    Node.prototype.getFirstDescendant = function (condition) {
        try {
            for (var _a = tslib_1.__values(this.getDescendantsIterator()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var descendant = _b.value;
    ...
    Node.prototype.offsetPositions = function (offset) {
        ...
        try {
            for (var _a = tslib_1.__values(this.getChildren()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var child = _b.value;
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _a = tslib_1.__values(this.getCompilerChildren()), _b = _a.next();
                    _d.label = 1;
                case 1:
    ...
    Node.prototype.getChildSyntaxList = function () {
        ...
        try {
            for (var _a = tslib_1.__values(node.getCompilerChildren()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var child = _b.value;
                if (!passedBrace)
    ...
    Node.prototype.getDescendantsIterator = function () {
        var _a, _b, descendant, e_9_1, e_9, _c;
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 5, 6, 7]);
                    _a = tslib_1.__values(this.getCompilerDescendantsIterator()), _b = _a.next();
                    _d.label = 1;
                case 1:
                    if (!!_b.done) return [3 /*break*/, 4];
                    descendant = _b.value;
    ...
    Node.prototype.getDescendantStatements = function () {
        ...
        function handleNode(thisNode, node) {
            if (handleStatements(thisNode, node))
                ...
                if (arrowFunction.body.kind !== typescript_1.SyntaxKind.Block)
                    statements.push(thisNode.getNodeFromCompilerNode(arrowFunction.body));
                else
        ...
        function handleStatements(thisNode, node) {
            if (node.statements == null)
                return false;
            try {
                for (var _a = tslib_1.__values(node.statements), _b = _a.next(); !_b.done; _b = _a.next()) {
    ...
    Node.prototype.getChildAtPos = function (pos) {
        if (pos < this.getPos() || pos >= this.getEnd())
            return undefined;
        try {
            for (var _a = tslib_1.__values(this.getCompilerChildren()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var child = _b.value;
    ...
    Node.prototype.getNodeProperty = function (propertyName) {
        ...
        return this.getNodeFromCompilerNode(this.compilerNode[propertyName]);
    };
    ...
    Node.prototype.getChildIndex = function () {
        ...
        var i = 0;
        try {
            for (var _a = tslib_1.__values(parent.getCompilerChildren()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var child = _b.value;
    ...
    Node.prototype.replaceWithText = function (textOrWriterFunction) {
        var newText = utils_1.getTextFromStringOrWriter(this.getWriter(), textOrWriterFunction);
        if (utils_1.TypeGuards.isSourceFile(this)) {
    ...
    Node.prototype.getFirstAncestorByKind = function (kind) {
        try {
            for (var _a = tslib_1.__values(this.getAncestors(kind === typescript_1.SyntaxKind.SyntaxList)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var parent = _b.value;
    ...
    Node.prototype.getCompilerDescendantsIterator = function () {
        ...
        function getDescendantsIterator(node) {
            var _a, _b, child, e_16_1, e_16, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 6, 7, 8]);
                        _a = tslib_1.__values(node.getChildren(compilerSourceFile)), _b = _a.next();
                        _d.label = 1;
                    case 1:
    ...
    Node.prototype.getCompilerPreviousSibling = function (condition) {
        try {
            for (var _a = tslib_1.__values(this.getCompilerPreviousSiblings()), _b = _a.next(); !_b.done; _b = _a.next()) {
    ...
    Node.prototype.getCompilerNextSibling = function (condition) {
        try {
            for (var _a = tslib_1.__values(this.getCompilerNextSiblings()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var sibling = _b.value;
                if (condition == null || condition(sibling))
                    return sibling;
            }
