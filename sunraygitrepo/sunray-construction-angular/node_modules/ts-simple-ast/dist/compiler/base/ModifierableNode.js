...
function ModifierableNode(Base) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.getFirstModifierByKind = function (kind) {
            try {
                for (var _a = tslib_1.__values(this.getCompilerModifiers()), _b = _a.next(); !_b.done; _b = _a.next()) {
        ...
        class_1.prototype.addModifier = function (text) {
            ...
            function getInsertInfo(node) {
                ...
                var index = 0;
                try {
                    for (var _a = tslib_1.__values(getAddAfterModifierTexts(text)), _b = _a.next(); !_b.done; _b = _a.next()) {
