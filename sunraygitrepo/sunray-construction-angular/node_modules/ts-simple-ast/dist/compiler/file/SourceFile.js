...
var SourceFile = /** @class */ (function (_super) {
    ...
    SourceFile.prototype.getExportedDeclarations = function () {
        ...
        function getDeclarationsForSymbols() {
            function getDeclarationHandlingExportSpecifiers(declaration) {
                var _a, _b, d, e_2_1, identifier, symbol, _c, _d, d, e_3_1, e_2, _e, e_3, _f;
                return tslib_1.__generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 1:
                            ...
                            _a = tslib_1.__values(declaration.getLocalTargetDeclarations()), _b = _a.next();
                            _g.label = 2;
                        case 2:
            ...
            var handledDeclarations, exportSymbols_1, exportSymbols_1_1, symbol, _a, _b, declaration, e_4_1, e_5_1, e_5, _c, e_4, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        _a = tslib_1.__values(symbol.getDeclarations()), _b = _a.next();
                        _e.label = 4;
                    case 4:
    ...
    SourceFile.prototype.indent = function (positionRangeOrPos, times) {
        ...
        var newLines = [];
        try {
            for (var _a = tslib_1.__values(sourceFileText.substring(startLinePos, endLinePos).split("\n")), _b = _a.next(); !_b.done; _b = _a.next()) {
                var line = _b.value;
     ...
     * @param settings - Format code settings.
     */
    SourceFile.prototype.organizeImports = function (settings) {
        if (settings === void 0) { settings = {}; }
        this.applyTextChanges(utils_1.ArrayUtils.flatten(this.global.languageService.organizeImports(this, settings).map(function (r) { return r.getTextChanges(); })));
        return this;
    };
    /**
...
function updateStringLiteralReferences(nodeReferences) {
    try {
        for (var nodeReferences_1 = tslib_1.__values(nodeReferences), nodeReferences_1_1 = nodeReferences_1.next(); !nodeReferences_1_1.done; nodeReferences_1_1 = nodeReferences_1.next()) {
            var _a = tslib_1.__read(nodeReferences_1_1.value, 2), stringLiteral = _a[0], sourceFile = _a[1];
        ...
        try {
            if (nodeReferences_1_1 && !nodeReferences_1_1.done && (_b = nodeReferences_1.return)) _b.call(nodeReferences_1);
        }
