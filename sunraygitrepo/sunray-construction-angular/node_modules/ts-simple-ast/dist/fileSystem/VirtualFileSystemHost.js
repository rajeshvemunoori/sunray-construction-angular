...
var VirtualFileSystemHost = /** @class */ (function () {
    ...
    VirtualFileSystemHost.prototype.deleteSync = function (path) {
        ...
        if (this.directories.has(path)) {
            try {
                ...
                for (var _a = tslib_1.__values(getDescendantDirectories(this.directories.getKeys(), path)), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var descendantDirPath = _b.value;
    ...
    VirtualFileSystemHost.prototype.moveSync = function (srcPath, destPath) {
        ...
        if (this.fileExistsSync(srcPath)) {
            ...
            try {
                ...
                for (var _a = tslib_1.__values(getDescendantDirectories(this.directories.getKeys(), srcPath)), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var descendantDirPath = _b.value;
    ...
    VirtualFileSystemHost.prototype._copyDirInternal = function (from, to) {
        ...
        try {
            for (var _a = tslib_1.__values(dir.files.getEntries()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var fileEntry = _b.value;
    ...
    VirtualFileSystemHost.prototype.glob = function (patterns) {
        ...
        function getAllFilePaths(directories) {
            var directories_1, directories_1_1, dir, e_6_1, e_6, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, 6, 7]);
...
function getDescendantDirectories(directoryPaths, dirPath) {
    var directoryPaths_1, directoryPaths_1_1, path, e_7_1, e_7, _a;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, 6, 7]);
