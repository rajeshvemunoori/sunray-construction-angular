...
var Directory = /** @class */ (function () {
        ...
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    _a = tslib_1.__values(this.getSourceFiles()), _b = _a.next();
                    _g.label = 1;
                case 1:
                ...
                case 7:
                    ...
                    _c = tslib_1.__values(this.getDirectories()), _d = _c.next();
                    _g.label = 8;
                case 8:
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _a = tslib_1.__values(this.getDirectories()), _b = _a.next();
                    _d.label = 1;
                case 1:
    ...
    Directory.prototype.emit = function (options) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var fileSystemWrapper, writeTasks, outputFilePaths, _a, _b, emitResult, e_4_1, e_4, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        _a = tslib_1.__values(this._emitInternal(options)), _b = _a.next();
                        _d.label = 2;
                    case 2:
    ...
    Directory.prototype.emitSync = function (options) {
        ...
        var outputFilePaths = [];
        try {
            for (var _a = tslib_1.__values(this._emitInternal(options)), _b = _a.next(); !_b.done; _b = _a.next()) {
            ...
            return tslib_1.__generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        _a = tslib_1.__values(directory.getSourceFiles()), _b = _a.next();
                        _k.label = 1;
                    case 1:
                    ...
                    case 3:
                        ...
                        _c = tslib_1.__values(output.getOutputFiles()), _d = _c.next();
                        _k.label = 4;
                    case 4:
                    ...
                    case 14:
                        ...
                        _e = tslib_1.__values(directory.getDirectories()), _f = _e.next();
                        _k.label = 15;
                    case 15:
    ...
    Directory.prototype._copyInternal = function (newPath, options) {
        ...
        try {
            ...
            for (var copyingDirectories_1 = tslib_1.__values(copyingDirectories), copyingDirectories_1_1 = copyingDirectories_1.next(); !copyingDirectories_1_1.done; copyingDirectories_1_1 = copyingDirectories_1.next()) {
                var _a = copyingDirectories_1_1.value, directory = _a.directory, oldPath = _a.oldPath, newDirPath = _a.newDirPath;
            ...
            try {
                if (copyingDirectories_1_1 && !copyingDirectories_1_1.done && (_b = copyingDirectories_1.return)) _b.call(copyingDirectories_1);
            }
        ...
        try {
            ...
            for (var copyingSourceFiles_1 = tslib_1.__values(copyingSourceFiles), copyingSourceFiles_1_1 = copyingSourceFiles_1.next(); !copyingSourceFiles_1_1.done; copyingSourceFiles_1_1 = copyingSourceFiles_1.next()) {
                var _c = copyingSourceFiles_1_1.value, sourceFile = _c.sourceFile, newFilePath = _c.newFilePath;
            ...
            try {
                if (copyingSourceFiles_1_1 && !copyingSourceFiles_1_1.done && (_d = copyingSourceFiles_1.return)) _d.call(copyingSourceFiles_1);
            }
        ...
        try {
            ...
            for (var copyingSourceFiles_2 = tslib_1.__values(copyingSourceFiles), copyingSourceFiles_2_1 = copyingSourceFiles_2.next(); !copyingSourceFiles_2_1.done; copyingSourceFiles_2_1 = copyingSourceFiles_2.next()) {
                var _e = copyingSourceFiles_2_1.value, references = _e.references, newFilePath = _e.newFilePath;
            ...
            try {
                if (copyingSourceFiles_2_1 && !copyingSourceFiles_2_1.done && (_f = copyingSourceFiles_2.return)) _f.call(copyingSourceFiles_2);
            }
            finally { if (e_11) throw e_11.error; }
        }
        return this.global.compilerFactory.getDirectoryFromCache(newPath);
        var e_9, _b, e_10, _d, e_11, _f;
    };
    /**
    ...
    Directory.prototype._moveInternal = function (newPath, options) {
        ...
        try {
            ...
            for (var movingDirectories_1 = tslib_1.__values(movingDirectories), movingDirectories_1_1 = movingDirectories_1.next(); !movingDirectories_1_1.done; movingDirectories_1_1 = movingDirectories_1.next()) {
                var _a = movingDirectories_1_1.value, directory = _a.directory, oldPath = _a.oldPath, newDirPath = _a.newDirPath;
            ...
            try {
                if (movingDirectories_1_1 && !movingDirectories_1_1.done && (_b = movingDirectories_1.return)) _b.call(movingDirectories_1);
            }
        ...
        try {
            ...
            for (var movingSourceFiles_1 = tslib_1.__values(movingSourceFiles), movingSourceFiles_1_1 = movingSourceFiles_1.next(); !movingSourceFiles_1_1.done; movingSourceFiles_1_1 = movingSourceFiles_1.next()) {
                var _c = movingSourceFiles_1_1.value, sourceFile = _c.sourceFile, newFilePath = _c.newFilePath;
            ...
            try {
                if (movingSourceFiles_1_1 && !movingSourceFiles_1_1.done && (_d = movingSourceFiles_1.return)) _d.call(movingSourceFiles_1);
            }
        ...
        try {
            ...
            for (var movingSourceFiles_2 = tslib_1.__values(movingSourceFiles), movingSourceFiles_2_1 = movingSourceFiles_2.next(); !movingSourceFiles_2_1.done; movingSourceFiles_2_1 = movingSourceFiles_2.next()) {
                var _e = movingSourceFiles_2_1.value, sourceFile = _e.sourceFile, references = _e.references;
            ...
            try {
                if (movingSourceFiles_2_1 && !movingSourceFiles_2_1.done && (_f = movingSourceFiles_2.return)) _f.call(movingSourceFiles_2);
            }
            finally { if (e_14) throw e_14.error; }
        }
        return this;
        var e_12, _b, e_13, _d, e_14, _f;
    };
    /**
    ...
    Directory.prototype.delete = function () {
        ...
        try {
            for (var _a = tslib_1.__values(this.getSourceFiles()), _b = _a.next(); !_b.done; _b = _a.next()) {
        ...
        try {
            for (var _d = tslib_1.__values(this.getDirectories()), _e = _d.next(); !_e.done; _e = _d.next()) {
                var dir = _e.value;
                dir.delete();
            }
        }
