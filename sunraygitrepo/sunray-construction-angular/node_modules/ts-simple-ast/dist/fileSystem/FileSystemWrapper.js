...
var Directory = /** @class */ (function () {
    ...
    Directory.prototype.getWasEverDeleted = function () {
        if (this.wasEverDeleted)
            return true;
        try {
            for (var _a = tslib_1.__values(this.getAncestorsIterator()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var ancestor = _b.value;
    ...
    Directory.prototype.setIsDeleted = function (isDeleted) {
        ...
        if (isDeleted) {
            ...
            try {
                for (var _a = tslib_1.__values(this.childDirs), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var child = _b.value;
    ...
    Directory.prototype.hasOperation = function (operationMatches) {
        try {
            for (var _a = tslib_1.__values(this.operations), _b = _a.next(); !_b.done; _b = _a.next()) {
                var operation = _b.value;
...
var FileSystemWrapper = /** @class */ (function () {
    ...
    FileSystemWrapper.prototype.flush = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var operations, operations_1, operations_1_1, operation, e_5_1, e_5, _a;
    ...
    FileSystemWrapper.prototype.flushSync = function () {
        try {
            for (var _a = tslib_1.__values(this.getAndClearOperations()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var operation = _b.value;
    ...
    FileSystemWrapper.prototype.saveForDirectory = function (dirPath) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var dir, operations, operations_2, operations_2_1, operation, e_7_1, e_7, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        dirPath = this.getStandardizedAbsolutePath(dirPath);
    ...
    FileSystemWrapper.prototype.saveForDirectorySync = function (dirPath) {
        ...
        try {
            for (var _a = tslib_1.__values(this.getAndClearOperationsForDir(dir)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var operation = _b.value;
                this.executeOperationSync(operation);
            }
        }
    ...
    FileSystemWrapper.prototype.getAndClearOperationsForDir = function (dir) {
        ...
        try {
            for (var _a = tslib_1.__values(tslib_1.__spread([dir], dir.getDescendants())), _b = _a.next(); !_b.done; _b = _a.next()) {
                var currentDir = _b.value;
    ...
    FileSystemWrapper.prototype.getAndClearOperations = function () {
        var operations = [];
        try {
            for (var _a = tslib_1.__values(this.directories.getValues()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var dir = _b.value;
